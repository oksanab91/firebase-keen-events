...
var cacheRef =  app.database().ref('/keen/cache')

// var cacheRef = new Firebase('https://fir-events-32d5f.firebaseio.com/keen/cache'),
var recordLimit = 100, // 5 minutes of records
    avgCostByGender;
